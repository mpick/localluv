...
<div class="row">
  <div class='span10 offset1 fundingComplete' style='text-align:center; margin-bottom: 10em'>
  	...
  	<h3>Your contribution of <b>$<?= $this->amount ?></b> to the <b><a href='/bands/<?= $project->slug ?>'><?= $project->title ?></a></b> goal <b><a href='/bands/<?= $project->slug ?>'>&quot;<?= $this->goal->name ?>&quot;</a></b> has been successfully processed. You are super awesome.</h3><br>
  ...
  &text=<?= urlencode("I backed " . $this->goal->name . ': on @beabandaid') ?>" target='_new'><i class='icon-twitter'></i>Share on Twitter</a> <a class='btn btn-info' style='background: #596F90' href="https://www.facebook.com/sharer/sharer.php?u=http://<?=urlencode($_SERVER['SERVER_NAME'].'/bands/' . $project->slug)?>" target='_blank'><i class='icon-facebook'></i> Share on Facebook</a> 
  ...
  <meta property="og:title" content="beabandaid: <?= $this->goal->name ?>" />
